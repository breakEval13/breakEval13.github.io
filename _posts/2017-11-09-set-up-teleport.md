...
![Teleport 工作模式](https://112firshme11224.test.upcdn.net/markdown/hsnj8.png)
...
![OTP CMD](https://112firshme11224.test.upcdn.net/markdown/chuyf.png)

访问该地址后初始化密码及 OTP

![init OTP](https://112firshme11224.test.upcdn.net/markdown/czwmd.png)
...
![Web login](https://112firshme11224.test.upcdn.net/markdown/9yf6k.png)

通过 Cluster 选项可以切换不同集群，点击后面的用户名可以选择不同用户登录到不同主机(用户授权在添加用户时控制)，登陆成功后如下

![Login Success](https://112firshme11224.test.upcdn.net/markdown/m7hz5.png)

通过 Teleport 进行的所有操作可以通过审计菜单进行操作回放

![Audit](https://112firshme11224.test.upcdn.net/markdown/c8a74.png)
