...
![enable https for GitHub Pages](https://zmatsh.b0.upaiyun.com/posts/github/github-pages-with-https.png)
...
2. 按工具里的要求填好三个部分的内容，依次是
   ...
   * 用于注册 Kloudsec 的邮箱和为 Kloudsec 账户设置的密码。
     ...
     ![Register a Kloudsec account](https://zmatsh.b0.upaiyun.com/posts/github/https-kloudsec-account.png)

   * GitHub Pages 项目的 URL 和绑定的域名。

     ![Configure your Github Page](https://zmatsh.b0.upaiyun.com/posts/github/https-config-gh.png)

   * 到你的域名解析控制面板里添加工具要求的 A 记录。

     ![Configure your DNS settings](https://zmatsh.b0.upaiyun.com/posts/github/https-config-dns.png)
...
4. 进入到 Dashboard 的 SETTINGS，在 Web Server Origin IP / Hostname 一栏填上 GitHub Pages 的可用 IP，比如我填写的是 `103.245.222.133`。
   ...
   ![Web Server Origin IP](https://zmatsh.b0.upaiyun.com/posts/github/https-config-server-ip.png)

5. 开启 HTTP 自动跳转到 HTTPS。*（非必须，按自己需求来。）*

   进入到 Dashboard 的 PROTECTION，点击 SSL Encryption 里的按钮，选择你的网站：

   ![PROTECTION](https://zmatsh.b0.upaiyun.com/posts/github/https-config-redirection-1.png)

   将 Automatically redirect to HTTPS site? 下面的开关切换到 ON：

   ![Automatically redirect to HTTPS site?](https://zmatsh.b0.upaiyun.com/posts/github/https-config-redirection-2.png)
...
6. 进入到 Dashboard 的 PLUGIN STORE，启用 Offline Protection、Page Optimizer 和 One-Click Encryption，一般来讲免费的计划就够用了，如果你想要使用付费计划提供更多更好的服务，那按需选择吧。
   ...
   ![Plugin Store](https://zmatsh.b0.upaiyun.com/posts/github/https-config-plugin-store.png)
